        ...
        <div class="col-12">
            <div class="card shadow-sm border-0 rounded-4">
                ...
                <div class="card-body">
                        ...
                        <div class="row">
                            @foreach($classes as $class)
                                <div class="col-md-3 mb-3">
                                    <a href="{{ route('pentadbir.profilMurid', ['kelas' => $class]) }}" class="btn btn-outline-primary w-100">
                                        {{ $class }}
                                    </a>
                                </div>
                            @endforeach
                    ...
                    @else
                        <div class="mb-3">
                            <a href="{{ route('pentadbir.profilMurid') }}" class="btn btn-secondary">
                            ...
                            <div class="row">
                                @foreach($students as $student)
                                    <div class="col-md-4 mb-3">
                                        <a href="{{ route('pentadbir.profilMurid', ['kelas' => $selectedClass, 'murid' => $student->MyKidID]) }}" class="card text-decoration-none">
                                            <div class="card-body">
