                ...
                <div class="card-body">
                    ...
                    <div class="card border-0 bg-light mb-3" style="padding: 0.75rem;">
                        <form action="{{ route('pentadbir.laporan') }}" method="GET" id="filterForm">
                            <div class="row g-2 align-items-end">
                                ...
                                <div class="col-md-2">
                                    <a href="{{ route('pentadbir.laporan') }}" class="btn btn-outline-secondary btn-sm w-100">
                            ...
                            <tbody>
                                @if($prestasi->isNotEmpty())
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $record->tarikhRekod ? $record->tarikhRekod->format('d/m/Y') : 'N/A' }}</td>
                                    </tr>
                                    @endforeach
                                @else
                                    <tr>
                    ...
                    @endif
                        ...
                        <div class="tab-pane fade" id="kehadiran" role="tabpanel">
                            <!-- Kehadiran Filters -->
                            <div class="card border-0 bg-light mb-3" style="padding: 0.75rem;">
                                <form action="{{ route('pentadbir.laporan') }}" method="GET" id="kehadiranFilterForm">
