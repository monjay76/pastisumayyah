...
class PrestasiController extends Controller
{
    ...
    public function storeOrUpdate(Request $request)
    {
        try {
            ...
            // Get guru ID from session (since LoginController uses session-based auth)
            $user = session('user');
            if (!$user || !isset($user->ID_Guru)) {
                \Log::error('Authentication error: User session not found or ID_Guru missing', [
                    'session_user' => $user,
            ...
            \Log::info('Saving prestasi assessment', [
                'murid_id' => $muridId,
